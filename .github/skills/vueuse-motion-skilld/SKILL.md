...
Use `skilld search "query" -p @vueuse/motion` instead of grepping `.skilld/` directories. Run `skilld search --guide -p @vueuse/motion` for full syntax, filters, and operators.
